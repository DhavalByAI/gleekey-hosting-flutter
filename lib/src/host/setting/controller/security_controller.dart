...
class SecurityController extends GetxController {
  static SecurityController get to => Get.put(SecurityController());
  ...
  Future<bool?> changeSecurityPassApi({
    ...
    try {
      dio.Response response = await dio.Dio().post(ApiConfig.changeSecurityPass,
      ...
      if (response.statusCode == 200) {
        ...
        if (response.data != null) {
          print('changePassRes  ' + changePassRes.value.toString());
